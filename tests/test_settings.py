...
class TestUtilityFunctions:
    ...
    def test_validate_required_config_empty(self) -> None:
        ...
        with pytest.raises(ValueError, match="Missing required configuration 'api_key' for TestProvider"):
...
class TestOpenAIVisionConfig:
    ...
    def test_init_with_defaults(self, monkeypatch: MonkeyPatch) -> None:
        ...
        env_vars = [
            "OPENAI_API_KEY", "OPENAI_VISION_API_KEY", 
            "OPENAI_MODEL", "OPENAI_VISION_MODEL",
            "OPENAI_BASE_URL", "OPENAI_VISION_BASE_URL",
...
class TestAzureOpenAIVisionConfig:
    ...
    def test_init_with_defaults(self, monkeypatch: MonkeyPatch) -> None:
        ...
        optional_vars = ["AZURE_OPENAI_MODEL", "AZURE_OPENAI_API_URL", "AZURE_OPENAI_API_VERSION"]
...
class TestAnthropicAWSBedrockConfig:
    ...
    def test_init_with_defaults(self, monkeypatch: MonkeyPatch) -> None:
        ...
        env_vars = [
            ...
            "AWS_REGION", "AWS_BEDROCK_VPC_ENDPOINT_URL", "ANTHROPIC_BEDROCK_MODEL"
        ]
        for var in env_vars:
            monkeypatch.delenv(var, raising=False)
...
class TestEnvironmentVariableIntegration:
    ...
    def test_max_concurrent_tasks_env_var(self, monkeypatch: MonkeyPatch) -> None:
        ...
        with patch('aicapture.settings.os.getenv') as mock_getenv:
            ...
            assert aicapture.settings.MAX_CONCURRENT_TASKS == 20  # Current value in module
